...
export default function LoginPage() {
    return (
        <div>
            <header className="flex items-center justify-between px-4 sm:px-8 py-3 bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-slate-100">
                <div className="flex items-center gap-2">
                    <div className="bg-blue-600 p-1.5 rounded-lg">
                        <FileText className="text-white w-5 y-5 sm:w-6 sm:h-6" />
                    </div>
                    <Link href="/">
                        <span className="text-xl sm:text-xl  font-bold tracking-tight text-slate-800 hidden sm:block">
                            CheckPoint AI
                        </span>
